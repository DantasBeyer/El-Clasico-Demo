class Game {
    constructor() {
      ...
      this.gameOverElement = document.querySelector(".game-over-real");
      this.gameWinElement = document.querySelector(".you-Win-real");
  ...
  checkCollision() {
    ...
    lostTheGame() { 
      ...
      this.gameOverElement.classList.remove("hiddenReal");  
      stopTheGame()
  } 

    winTheGame(){
      
      this.gameWinElement.classList.remove("hidden2Real")
      stopTheGame()
    }
